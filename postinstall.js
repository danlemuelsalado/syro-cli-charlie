...
async function install(callback) {
    ...
    const src = `./dist/syro-cli-charlie-${process.platform}-${ARCH_MAPPING[process.arch]}_${process.platform}_${ARCH_MAPPING[process.arch]}${archVersionExtension}/${opts.binName}`;
